...
Mateo must ask his administrator to update his policies to allow him to access the `GetTranscriptionJob` operation using the `transcribe:GetTrascriptionJob` action\.
